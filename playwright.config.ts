...
const databaseURL = process.env.E2E_DATABASE_URL || process.env.DATABASE_URL || "mongodb://127.0.0.1:27017/pitchgenie-e2e"
...
export default defineConfig({
  ...
  webServer: {
    command: process.env.CI
      ? "pnpm start -p 3200"
      : "pnpm db:deploy && NEXTAUTH_URL=https://e2e.example.com pnpm build && pnpm start -p 3200",
