export default function Loading() {
  return (
    <div className="min-h-screen bg-background" aria-busy="true" aria-label="Loading pitch deck generator">
      ...
      <div className="container mx-auto space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl space-y-3 text-center">
          <div className="mx-auto h-16 w-16 rounded-full bg-accent/15 motion-safe:animate-pulse" />
          <div className="mx-auto h-9 w-72 rounded bg-muted motion-safe:animate-pulse" />
